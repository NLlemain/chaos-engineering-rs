...
- WinGet: `NinianLemain.ChaosEngineeringRs.yaml` is published in [`microsoft/winget-pkgs`](https://github.com/microsoft/winget-pkgs/tree/master/manifests/n/NinianLemain/ChaosEngineeringRs).
